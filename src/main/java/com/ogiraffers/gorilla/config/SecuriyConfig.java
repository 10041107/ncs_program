package com.ogiraffers.gorilla.config;

import com.ogiraffers.gorilla.auth.AuthenticationService;
import com.ogiraffers.gorilla.config.handler.AuthenFailHandler;
